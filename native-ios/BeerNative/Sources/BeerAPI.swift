...
final class BeerAPI {
    ...
    private static let userAgentOwner = "PlexiBeer/4.0.4 (iPhone; native owner) [lan-vpn]"
    private static let userAgentInvite = "PlexiBeer/4.0.4 (iPhone; native invite) [wan]"
