...
final class BeerAPI {
    ...
    private static let userAgentOwner = "PlexiBeer/3.8.0 (iPhone; native owner) [lan-vpn]"
    private static let userAgentInvite = "PlexiBeer/3.8.0 (iPhone; native invite) [wan]"
